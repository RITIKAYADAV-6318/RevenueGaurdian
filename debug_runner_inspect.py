...
runner = Runner(agent=agent, session_service=InMemorySessionService(), app_name='revenue_guardian')
...
for idx, item in enumerate(itertools.islice(raw, 3)):
    ...
    print('attrs', [a for a in dir(item) if not a.startswith('_')][:50])
